...
@Client.on_message(command(["hearts", "قلب"]) & filters.me)
...
@Client.on_message(command(["emoji" , "ایموجی"])& SUDOERS)
...
`.emoji .ایموجی   ایموج.` - **a تغییر پشت سر هم ایموجی *
`.heart  .قلب   قلب. - ** A+ تغییر ایموجی قلب **
"""
